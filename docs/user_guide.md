...
Рекомедуется собрать данные от 3-х недель. Это повысит вероятность того, что в журнал пападут операции, которые выполняются один раз в месяц в определенный период.
Пример конфигурации технологического журнала [logcfg.xml](docs/example/logcfg.xml) 

---

### 2. Запуск обработки
Запустите обработку **"Анализ технологического журнала"**:  
![start_analysis](docs/img/start_analysis.jpg)

Выберите каталог, в котором расположены файлы технологического журнала:  
![select_directory](docs/img/select_directory.jpg)
...
![settings_fill](docs/img/settings_fill.jpg)
...
![cpu_control](docs/img/cpu_control.jpg)
...
![select_templates](docs/img/select_templates.jpg)
...
![set_subdirs](docs/img/set_subdirs.jpg)
...
![run_analysis](docs/img/run_analysis.jpg)
...
![result_excel](docs/img/result_excel.jpg)
...
![show_json](docs/img/show_json.jpg)
...
![template](docs/img/template.jpg)
...
![template_subdirs](docs/img/template_subdirs.jpg)
